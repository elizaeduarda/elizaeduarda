...
Atuo na área de **Segurança da Informação**, com foco em **Blue Team**, análise de segurança e proteção de ambientes contra ameaças cibernéticas.

Também tenho experiência com **desenvolvimento de software**, utilizando programação para resolver problemas, automatizar processos e construir soluções tecnológicas.

🚀 Interesses principais:

- 🛡️ Cybersecurity e defesa de sistemas
- 🔎 Análise e investigação de incidentes
- 💻 Desenvolvimento de software
- ⚙️ Automação e engenharia aplicada à segurança
---
